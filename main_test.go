...
/* TODO delete or move following tests to a new separate module as helpers_test.go because 
the follwing tests as they may not be required now as they are already validated by tests for calling functions
